...
const file_payment_payment_proto_rawDesc = "" +
	"\n" +
	"\x15payment/payment.proto\x12\apayment\x1a\x1fgoogle/protobuf/timestamp.proto\"\x18\n" +
	...
	"\n" +
	"updated_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\tupdatedAt2\xf0\x01\n" +
	"\x0ePaymentService\x12C\n" +
	"\x0eProcessPayment\x12\x17.payment.PaymentRequest\x1a\x18.payment.PaymentResponse\x12N\n" +
	"\x17SubscribeToOrderUpdates\x12\x15.payment.OrderRequest\x1a\x1a.payment.OrderStatusUpdate0\x01\x12I\n" +
	"\x0fGetPaymentStats\x12\x1f.payment.GetPaymentStatsRequest\x1a\x15.payment.PaymentStatsBBZ@github.com/Almukhammed77/order-payment-generated/payment;paymentb\x06proto3"
...
var file_payment_payment_proto_goTypes = []any{
	(*GetPaymentStatsRequest)(nil), // 0: payment.GetPaymentStatsRequest
	(*PaymentStats)(nil),           // 1: payment.PaymentStats
...
var file_payment_payment_proto_depIdxs = []int32{
	...
	4, // 2: payment.PaymentService.SubscribeToOrderUpdates:input_type -> payment.OrderRequest
	0, // 3: payment.PaymentService.GetPaymentStats:input_type -> payment.GetPaymentStatsRequest
	3, // 4: payment.PaymentService.ProcessPayment:output_type -> payment.PaymentResponse
	5, // 5: payment.PaymentService.SubscribeToOrderUpdates:output_type -> payment.OrderStatusUpdate
	1, // 6: payment.PaymentService.GetPaymentStats:output_type -> payment.PaymentStats
